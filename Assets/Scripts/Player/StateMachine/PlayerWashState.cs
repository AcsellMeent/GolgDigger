...
public class PlayerWashState : PlayerMovementState
{
    public PlayerWashState(StateMachine stateMachine, PlayerComponentsProvider componentsProvider) : base(stateMachine, componentsProvider) { }
